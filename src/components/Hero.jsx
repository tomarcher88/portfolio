    ...
    >
      <p className="text-2xl text-center p-5 sm:px-24 md:px-60">
        ...
        <a href="https://github.com/tomarcher88" target="_blank">
          <span className="bg-opacity-60 bg-slate-500 px-1 rounded font-fjalla-one">
            HTML
          </span>
          ,{" "}
          <span className="bg-opacity-60 bg-slate-500 px-1 rounded font-fjalla-one">
        ...
        <a
          className="bg-opacity-60 bg-slate-500 px-1  rounded font-fjalla-one"
      ...
      <p className="text-2xl text-center sm:px-24 md:px-60">
